...
export interface ApiArtifactArtifact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::artifact.artifact', 'name'> & Attribute.Required;
    location: Attribute.JSON &
      Attribute.Required &
      Attribute.CustomField<'plugin::open-street-maps.location-picker'>;
...
export interface ApiCollectibleCollectible extends Schema.CollectionType {
  collectionName: 'collectibles';
  info: {
    singularName: 'collectible';
    pluralName: 'collectibles';
    displayName: 'Carimbos Digitais';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    seasons: Attribute.Component<'content.season', true>;
    description: Attribute.Blocks;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiResgateRecompensaResgateRecompensa
  extends Schema.CollectionType {
  collectionName: 'resgate_recompensas';
  info: {
    singularName: 'resgate-recompensa';
    pluralName: 'resgate-recompensas';
    displayName: 'Resgate Recompensas';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    user: Attribute.Relation<
      'api::resgate-recompensa.resgate-recompensa',
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    recompensa: Attribute.Relation<
      'api::resgate-recompensa.resgate-recompensa',
      'oneToOne',
      'api::reward.reward'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::collectible.collectible': ApiCollectibleCollectible;
      'api::project.project': ApiProjectProject;
      'api::resgate-recompensa.resgate-recompensa': ApiResgateRecompensaResgateRecompensa;
